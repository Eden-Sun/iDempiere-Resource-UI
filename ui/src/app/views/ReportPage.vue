  ...
  <div class="space-y-6">
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-lg font-semibold">報表</h1>
          <p class="mt-1 text-sm text-slate-600">系統統計與報表</p>
        </div>
      </div>
    </div>
    ...
    <div class="grid gap-6 md:grid-cols-3">
      <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div class="text-sm font-medium text-slate-500">總客戶數</div>
      ...
      <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div class="text-sm font-medium text-slate-500">庫存品項數</div>
        <div class="mt-2 text-3xl font-bold text-slate-900">
          <span v-if="loading">...</span>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <h2 class="text-base font-semibold mb-4">報表功能</h2>
      <p class="text-sm text-slate-600">詳細報表功能開發中...</p>
    </div>
  </div>
</template>
